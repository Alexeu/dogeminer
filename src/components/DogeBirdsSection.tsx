...
const birds: BirdType[] = [
  { id: "yellow", name: "Yellow Bird", nameKey: "birds.yellow", image: birdYellow, price: 4, eggsPerHour: 135, color: "#FCD34D", gradient: "from-yellow-400 to-yellow-500" },
  { id: "red", name: "Red Bird", nameKey: "birds.red", image: birdRed, price: 15, eggsPerHour: 641, color: "#EF4444", gradient: "from-red-400 to-red-500" },
  { id: "green", name: "Green Bird", nameKey: "birds.green", image: birdGreen, price: 45, eggsPerHour: 3206, color: "#22C55E", gradient: "from-green-400 to-green-500" },
  { id: "blue", name: "Blue Bird", nameKey: "birds.blue", image: birdBlue, price: 85, eggsPerHour: 10125, color: "#3B82F6", gradient: "from-blue-400 to-blue-500" },
  { id: "black", name: "Black Bird", nameKey: "birds.black", image: birdBlack, price: 250, eggsPerHour: 47250, color: "#1F2937", gradient: "from-gray-700 to-gray-900", textColor: "text-white" },
];
