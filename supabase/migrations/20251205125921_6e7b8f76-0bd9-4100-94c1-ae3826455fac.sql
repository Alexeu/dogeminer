-- Server-side mystery box opening function with secure RNG
...
DECLARE
  ...
  v_common_chars TEXT[][] := ARRAY[
    ['builder', 'Doge Builder', '0.00143'],
    ['astronaut', 'Doge Astronaut', '0.00143'],
    ['farmer', 'Doge Farmer', '0.00143'],
    ['chef', 'Doge Chef', '0.00143'],
    ['mechanic', 'Doge Mechanic', '0.00143'],
    ['artist', 'Doge Artist', '0.00143'],
    ['explorer', 'Doge Explorer', '0.00143']
  ];
  v_rare_chars TEXT[][] := ARRAY[
    ['pirate', 'Doge Pirate', '0.002015'],
    ['ninja', 'Doge Ninja', '0.002015'],
    ['samurai', 'Doge Samurai', '0.002015'],
    ['knight', 'Doge Knight', '0.002015'],
    ['viking', 'Doge Viking', '0.002015'],
    ['gladiator', 'Doge Gladiator', '0.002015']
  ];
  v_epic_chars TEXT[][] := ARRAY[
    ['wizard', 'Doge Wizard', '0.0026'],
    ['cyberpunk', 'Doge Cyberpunk', '0.0026'],
    ['vampire', 'Doge Vampire', '0.0026'],
    ['phoenix', 'Doge Phoenix', '0.0026']
  ];
  v_legendary_chars TEXT[][] := ARRAY[
    ['king', 'Doge King', '0.00325'],
    ['gold', 'Doge Gold', '0.00325'],
    ['dragon', 'Doge Dragon', '0.00325']
  ];
...
BEGIN
  ...
  -- Check for mythic (0.15% chance in legendary box only)
  IF p_box_id = 'legendary' THEN
    v_mythic_roll := random() * 100;
    IF v_mythic_roll <= 0.15 THEN
      v_is_mythic := TRUE;
      v_char_id_out := 'doge-supreme';
      v_char_name_out := 'Doge Supreme';
      v_char_rarity_out := 'legendary';
      v_char_mining_rate := 0.0065;
    END IF;
  END IF;
  
  -- If not mythic, determine rarity via RNG
  IF NOT v_is_mythic THEN
