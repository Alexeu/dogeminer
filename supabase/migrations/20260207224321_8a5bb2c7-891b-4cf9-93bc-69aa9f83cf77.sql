...
-- Drop the old version with UUID parameter type
DROP FUNCTION IF EXISTS public.claim_mining_investment_reward(p_investment_id uuid);

-- Recreate with consistent text parameter
